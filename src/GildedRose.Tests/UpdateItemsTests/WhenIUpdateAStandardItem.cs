...
namespace GildedRose.Tests.UpdateItemsTests
{
    ...
    public class WhenIUpdateAStandardItem
    {
        ...
        {
            var item = new StandardItem {SellIn = 1, Quality = 1 }.UpdateQuality();
        ...
        {
            var item = new StandardItem {  SellIn = 0, Quality = 2 }.UpdateQuality();
            Assert.That(item.Quality, Is.EqualTo(0));
        }
        ...
        {
            var item = new StandardItem { SellIn = 1, Quality = 0 }.UpdateQuality();
            Assert.That(item.Quality, Is.EqualTo(0));
        }
    }
