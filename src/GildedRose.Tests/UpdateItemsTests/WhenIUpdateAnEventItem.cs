...
namespace GildedRose.Tests.UpdateItemsTests
{
    [TestFixture]
        public class WhenIUpdateAnEventItem
        {
            ...
            {
                var item = new BackstagePassesToATAFKAL80ETCConcert {Quality = 1, SellIn = 11 }.UpdateQuality();
            ...
            {
                var item = new BackstagePassesToATAFKAL80ETCConcert { Quality = 1, SellIn = daysLeft }.UpdateQuality();
            ...
            {
                var item = new BackstagePassesToATAFKAL80ETCConcert {  Quality = 1, SellIn = 0 }.UpdateQuality();
            ...
            {
                var item = new BackstagePassesToATAFKAL80ETCConcert { Quality = 1, SellIn = 1 }.UpdateQuality();
