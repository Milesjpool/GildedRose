...
namespace GildedRose.Tests.UpdateItemsTests
{
    ...
    public class WhenIUpdateAQualityAgedItem
    {
        ...
        {
            var item = new AgedBrie { Quality = 1, SellIn = 1 }.UpdateQuality();
        ...
        {
            var item = new AgedBrie { Quality = 50, SellIn = 1 }.UpdateQuality();
        ...
        {
            var item = new AgedBrie { Quality = 1, SellIn = 0 }.UpdateQuality();
